    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Alps Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Alps address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and alps: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Alps Core"), this);
    aboutAction->setStatusTip(tr("Show information about Alps Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Alps Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Alps addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Alps addresses"));
    ...
    openAction->setStatusTip(tr("Open a alps: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Alps Core help message to get a list with possible Alps Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Alps Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Alps network", "", count));
    } else {
...
{
    QString strTitle = tr("Alps Core"); // default title
