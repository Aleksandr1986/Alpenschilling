    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Alps Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Alps Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  alps-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Alps in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ALPS, 0.1 ALPS, 1 ALPS and 10 ALPS -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Alps Core is shutting down...") + "<br /><br />" +
