...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Alps related functionality
...
/*
    ...
    allow endless transaction that would bloat Alps and make it unusable. To
