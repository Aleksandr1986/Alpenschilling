 ...
 *
 *   // network
 *   CAlpsNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.alps.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CAlpsNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: AlpsNetwork
// //   -- signature requirements : Key1(User)
// class CAlpsNetworkVariable : public CGovernanceObject
// {
// private:
