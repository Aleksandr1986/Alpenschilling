...
Only requiring some minor changes is alps.cpp.
...
Changes to alps.cpp
----------------------
alps.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
