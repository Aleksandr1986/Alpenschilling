...
This mechanism has been integrated into Bitcore-Node-Alps which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/alpspay/insight-api-alps#web-socket-api](https://github.com/alpspay/insight-api-alps#web-socket-api)
* API: [https://github.com/alpspay/insight-api-alps#instantsend-transactions](https://github.com/alpspay/insight-api-alps#instantsend-transactions)
...
By default, the Alps Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Alps Core daemon:
